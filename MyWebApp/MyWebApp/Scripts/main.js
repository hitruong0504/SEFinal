...
let products = [
    {
        ...
        description:
            'Xe ô tô điều khiển từ xa thế hệ mới với thiết kế sang trọng.',
        price: 250000,
        image:
            'https://image.vn/Upload/ProductImage/.jpg?width=550&height=550',
        count: 1,
    },
    {
        id: randomId(),
        name: 'Bộ lắp ráp lego',
        description:
            'Bộ lắp rap lego với chất liệu nhựa không độc hại.',
        price: 350000,
        image:
            'https://image.vn/Upload/ProductImage/.jpg?width=550&height=550',
        count: 1,
